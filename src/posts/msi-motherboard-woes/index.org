#+TITLE: MSI Motherboard Woes | kris.sh
#+OPTIONS: toc:nil num:nil author:nil timestamp:nil

#+BEGIN_EXPORT html
<h2>MSI Motherboard Woes</h2>
<time datetime="2024-02-04T14:59:53-06:00">February 4, 2024</time> - <span class="tags">Linux, UEFI</span>
#+END_EXPORT
...
Documentation of this behavior and a list of impacted motherboards exists on [[https://github.com/Foxboron/sbctl/issues/181][sbctl's issue tracker]].
...
There are quite a few other security issues with MSI motherboards that have been well explained on [[https://dawidpotocki.com/en/2023/02/26/msi-insecure-boot-part-2/#msis-other-security-issues][Dawid Potocki's blog]], so I won't go into those here.
