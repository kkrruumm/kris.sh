---
title: "Alpine Linux encrypted UKI install"
date: 2024-01-24T10:24:59-06:00
draft: false
tags: ['Linux', 'UEFI']
---
...
![setup-disk-script](/posts/alpine-encrypted-uki/images/setup-disk-image.png)
...
![lsblk output image](/posts/alpine-encrypted-uki/images/lsblk-output-image1.png)
...
![lsblk output image](/posts/alpine-encrypted-uki/images/lsblk-output-image2.png)
...
If you would like to use secure boot, follow the instructions on my [Secure Boot on Linux with sbctl](/posts/sbctl-secure-boot/index.html) post, signing **only** the UKI file we created in this post (`/boot/alpine.efi`).
