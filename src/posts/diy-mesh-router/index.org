#+TITLE: DIY Mesh Router | kris.sh
#+OPTIONS: toc:nil num:nil author:nil timestamp:nil

#+BEGIN_EXPORT html
<h2>DIY Mesh Router</h2>
<time datetime="2024-02-16T20:51:42-06:00">February 16, 2024</time> - <span class="tags">Linux, Networking</span>
#+END_EXPORT
...
If you just want to get your network up without reading further or performing a manual setup, the script can be found on my GitHub [[https://github.com/kkrruumm/wireless-eth-bridge][here]].
...
:PROPERTIES:
:CUSTOM_ID: enabling-ipv4-forwarding
:END:
